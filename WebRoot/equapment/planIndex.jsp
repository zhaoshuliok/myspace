						...
						<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
							...
							<tr onMouseOver="this.style.backgroundColor = 'white'" onMouseOut="this.style.backgroundColor = '#F5FAFE';">
								<td style="CURSOR:hand; HEIGHT:22px" align="center" width="5%">
									3</td>
								<td align="center"  width="22%">
									<a href="javascript:;" onClick="openWindow('planView.jsp?editflag=0&devPlanId=50bda830cbef453ab6e83f837359fc74&typeView=设备购置计划查询&pageNo=1&sumPage=37&lastRecordIndex=369&changeFlag=receive&direction=',800,450,'设备详细信息');" class="cl_01">偶极子电机</a></td>
								<td align="center"  width="9%">1</td>
								<td align="center"  width="9%">	1.00</td>
								<td align="center"  width="14%">
									</td>
							...
							<tr onMouseOver="this.style.backgroundColor = 'white'" onMouseOut="this.style.backgroundColor = '#F5FAFE';">
								<td style="CURSOR:hand; HEIGHT:22px" align="center" width="5%">
									5</td>
								<td align="center"  width="22%">
									<a href="javascript:;" onClick="openWindow('planView.jsp?editflag=0&devPlanId=5759cd69ea374523bb20721824c23511&typeView=设备购置计划查询&pageNo=1&sumPage=37&lastRecordIndex=369&changeFlag=receive&direction=',800,450,'设备详细信息');" class="cl_01">偶极子电机</a></td>
								<td align="center"  width="9%">1</td>
								<td align="center"  width="9%">	1.00</td>
								<td align="center"  width="14%">
									</td>
							...
							<tr onMouseOver="this.style.backgroundColor = 'white'" onMouseOut="this.style.backgroundColor = '#F5FAFE';">
								<td style="CURSOR:hand; HEIGHT:22px" align="center" width="5%">
									8</td>
								<td align="center"  width="22%">
									<a href="javascript:;" onClick="openWindow('planView.jsp?editflag=0&devPlanId=4e89c2b0a0114ebdb0c8d7155f5fd482&typeView=设备购置计划查询&pageNo=1&sumPage=37&lastRecordIndex=369&changeFlag=receive&direction=',800,450,'设备详细信息');" class="cl_01">有源杆状电机</a></td>
								<td align="center"  width="9%">1</td>
								<td align="center"  width="9%">	1.00</td>
								<td align="center"  width="14%">
									HFHZ-Z1</td>
							...
							<tr onMouseOver="this.style.backgroundColor = 'white'" onMouseOut="this.style.backgroundColor = '#F5FAFE';">
								<td style="CURSOR:hand; HEIGHT:22px" align="center" width="5%">
									10</td>
								<td align="center"  width="22%">
									<a href="javascript:;" onClick="openWindow('planView.jsp?editflag=0&devPlanId=359ce027809北京6192b93245d47fa765&typeView=设备购置计划查询&pageNo=1&sumPage=37&lastRecordIndex=369&changeFlag=receive&direction=',800,450,'设备详细信息');" class="cl_01">面包车</a></td>
								<td align="center"  width="9%">1</td>
								<td align="center"  width="9%">	1.00</td>
								<td align="center"  width="14%">
								...
								<td align="center" >
									<input type="checkbox" id="devPlanId"  name="devPlanId" value="359ce027809北京6192b93245d47fa765" />
								</td>
								
								
								<td align="center">
										<a href="javascript:;"
											onClick="openWindow('planEdit.jsp?editflag=1&devPlanId=359ce027809北京6192b93245d47fa765&typeView=设备购置计划查询&pageNo=1&sumPage=37&lastRecordIndex=369&changeFlag=receive&direction=',800,450);">
											<IMG src="${pageContext.request.contextPath }/images/edit.gif" style="CURSOR: hand" border="0" ></a>
							    </td>
								<td align="center" >
										<a href="javascript:Pub.submitActionWithForm('Form1','delDevicePlan.do?editflag=1&devPlanId=359ce027809北京6192b93245d47fa765&typeView=设备购置计划查询&pageNo=1&sumPage=37&lastRecordIndex=369&changeFlag=receive&direction=','F1')"
											onclick="returnMethod()"> <IMG src="${pageContext.request.contextPath }/images/delete.gif" style="CURSOR: hand"  border="0"></a>
								</td>
