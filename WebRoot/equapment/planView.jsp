			...
			<table cellSpacing="1" cellPadding="5" width="700" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="devName" type="text" maxlength="50" id="devName" size="19" value="GPS系统">&nbsp;<font color="#FF0000">*</font>
					</td>
				</tr>
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="specType" type="text" maxlength="25" id="specType" size="19" value="">&nbsp;<!-- font color="#FF0000">*</font -->
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="produceHome" type="text" maxlength="25" id="produceHome" size="19" value="">
					</td>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						数&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;量：
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgcolor="#ffffff" width="277">
						<input name="planDate" type="text" size="19" id="planDate" size="12" onclick="WdatePicker()" value="2011-10-01">&nbsp;<font color="#FF0000">*</font>
					</td>
				...
				<tr>
					...
					<input type="hidden" name="devPlanId" value="5cb793a299f64ae9a17953749715121d">
