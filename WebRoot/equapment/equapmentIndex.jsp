		...
		<tr>
			<td class="ta_01" align="center" bgcolor="#f5fafe">
				<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
					...
					正常</td>
					<td align="center"  width="10%">2007-06-25</td>
					...
					<td align="center"  width="8%">
					正常</td>
					<td align="center"  width="10%">2007-05-28</td>
					<td align="center"  width="10%">
					1月　</td>
					<td align="center"  width="9%" style="HEIGHT: 22px">
					北京</td>
					...
					<td align="center"  width="8%">
					正常</td>
					<td align="center"  width="10%">2007-05-27</td>
					<td align="center"  width="10%">
					1月　</td>
					<td align="center"  width="9%" style="HEIGHT: 22px">
					北京</td>
					...
					<td align="center"  width="8%">
					正常</td>
					<td align="center"  width="10%">2007-04-28</td>
					<td align="center"  width="10%">
					1月　</td>
					<td align="center"  width="9%" style="HEIGHT: 22px">
					北京</td>
					...
					<td align="center"  width="8%">
					维修</td>
					<td align="center"  width="10%">2007-04-30</td>
					<td align="center"  width="10%">
					1月　</td>
					<td align="center"  width="9%" style="HEIGHT: 22px">
					北京</td>
