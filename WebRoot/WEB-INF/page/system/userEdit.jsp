...
<html>
	...
	*/
	...
	function check_null(){
        ...
        if(checkNull(theForm.contactTel)){
  	   ...
  	   $("form:first").attr("action","elecUserAction_save.do");
	   $("form:first").submit();
	}
 ...
 <body>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select list="#request.jctUnitIDList" id="jctUnitID" name="jctUnitID"
					  listKey="ddlCode" listValue="ddlName"
					  cssStyle="width:155px">
			</s:select>
			<font color="#FF0000">*</font>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:password name="passwordconfirm" value="%{logonPwd}" id="passwordconfirm" maxlength="25"  size="22" showPassword="true"></s:password>
		</td>
	</tr>
