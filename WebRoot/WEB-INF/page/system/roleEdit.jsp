...
<table cellSpacing="1" cellPadding="0" width="90%" align="center" bgColor="#f5fafe" border="0">
 <tr>
  <td>
   <fieldset style="width:98%; border : 1px solid #73C8F9;text-align:left;COLOR:#023726;FONT-SIZE: 12px;"><legend align="left"><a href="#" onclick="displaypermission()"><span id="permissionflag">权限分配&nbsp;关闭</span></a></legend>
												...
												<s:iterator value="#request.popedomList">
														<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
															<td class="ta_01"  align="left" width="18%" height="22" background="../images/tablehead.jpg" >
																<s:if test="flag==1">
																	<input type="checkbox"  name="selectoper" id="<s:property value="id"/>_<s:property value="id"/>" value="<s:property value="id"/>_<s:property value="pid"/>" onClick='goSelect(this.id)' checked="checked">
																</s:if>
																<s:else>
																	<input type="checkbox"  name="selectoper" id="<s:property value="id"/>_<s:property value="id"/>" value="<s:property value="id"/>_<s:property value="pid"/>" onClick='goSelect(this.id)' >
																</s:else>
															...
															<td class="ta_01"  align="left" width="82%" height="22">
																<s:if test="childList!=null && childList.size()>0">
																	<s:iterator value="childList" status="status">
																		<div>
																			<s:if test="flag==1">
																				<input type="checkbox"  name="selectoper" id="<s:property value="pid"/>_<s:property value="id"/>" value="<s:property value="id"/>_<s:property value="pid"/>" onClick='goSelect(this.id)' checked="checked">
																			</s:if>
																			<s:else>
																				<input type="checkbox"  name="selectoper" id="<s:property value="pid"/>_<s:property value="id"/>" value="<s:property value="id"/>_<s:property value="pid"/>" onClick='goSelect(this.id)' >
																			</s:else>
  ...
  <tr>
   ...
   <fieldset style="width:98%; border : 1px solid #73C8F9;text-align:left;COLOR:#023726;FONT-SIZE: 12px;"><legend align="left"><a href="#" onclick="displayuser()"><span id="userflag">用户分配&nbsp;关闭</span></a></legend>
