        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
         <s:if test="#request.page!=null">
         		<tr>
		             ...
		             <td><input type="hidden" name="pageNO" value="${request.page.pageNo }" ></td> 
		             <td><input type="hidden" name="prevpageNO" value="${request.page.pageNo-1 }"></td>
		             <td><input type="hidden" name="nextpageNO" value="${request.page.pageNo+1 }"></td>
		             <td><input type="hidden" name="sumPage" value="${request.page.sumPage }" ></td>
	           </tr>
         </s:if>
