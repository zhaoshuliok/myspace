...
<HTML>
	<HEAD>
       ...
       function selectRole(){
    	  ...
    	  if($("select[name='roleID']").val()=="0"){
    		  $("#Form1").attr("action","elecRoleAction_home.do");
   		      $("#Form1").submit();        
          }else{
	...
	<form id="Form2" name="Form2" action="${pageContext.request.contextPath }/system/elecRoleAction_home.do" method="post" style="margin:0px;">
	  ...
	  <table cellSpacing="1" cellPadding="0" width="90%" align="center" bgColor="#f5fafe" border="0">
		 <tr>
		  <td>
		   <fieldset style="width:98%; border : 1px solid #73C8F9;text-align:left;COLOR:#023726;FONT-SIZE: 12px;"><legend align="left">权限分配</legend>
												...
												<s:iterator value="#request.popedomList">
														<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
															<td class="ta_01"  align="left" width="18%" height="22" background="../images/tablehead.jpg" >
																<input type="checkbox"  name="selectoper" id="<s:property value="id"/>_<s:property value="id"/>" value="" onClick='goSelect(this.id)' >
															...
															<td class="ta_01"  align="left" width="82%" height="22">
																<s:if test="childList!=null && childList.size()>0">
																	<s:iterator value="childList" status="status">
																		<div>
																			<input type="checkbox"  name="selectoper" id="<s:property value="pid"/>_<s:property value="id"/>" value="" onClick='goSelect(this.id)' >
																			<s:property value="name"/>
																		</div>
