...
function ifDelete(seqId){
	var flag = window.confirm("你确定要删除这篇资料文档吗？");
	if(!flag){
		return false;
	}
	else{
		window.location.href = "elecFileUploadAction_delete.do?seqId="+seqId;
	}
}
function exportPDF(){
	openWindow('${pageContext.request.contextPath }/dataChart/elecFileUploadAction_exportPDF.do',800,400);
}
  ...
  <table cellspacing="0" cellpadding="0" width="90%" align="center" bgcolor="#f5fafe" border="0">
	<TR>
		...
		<td class="ta_01" align="right" bgcolor="#ffffff">
			...
			<input  id="BT_Add" type="button" value="导出目录（PDF格式）" name="BT_Add" style="font-size:12px; color:black; height=20;width=50"   onclick="exportPDF()">	
		</td>
	</TR>
  </TABLE>		
 <table cellspacing="1" cellpadding="0" width="90%" align="center" bgcolor="#f5fafe" border="0">
				...
				<s:if test="#request.list!=null && #request.list.size()>0">
					<s:iterator value="#request.list" status="st">
						<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
							<td  align="center" width="6%"><s:property value="#st.count"/></td>
							<td align="center"  width="10%"><s:property value="projId"/></td>
							<td align="center"  width="10%"><s:property value="belongTo"/></td>
							<td align="center"  width="48%">
							<a href="#" onclick="openWindow('${pageContext.request.contextPath }/dataChart/elecFileUploadAction_download.do?seqId=<s:property value="seqId"/>','700','400');"><s:property value="fileName" escapeHtml="false"/></a></td>
							<td align="center"  width="20%"><s:property value="ecomment" escapeHtml="false"/></td>
							<td align="center" style="HEIGHT: 21px">
								<a href="javascript:void(0)" onclick="ifDelete('<s:property value="seqId"/>')">
