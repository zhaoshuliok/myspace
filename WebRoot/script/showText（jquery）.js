...
function showInfoWithPanel(obj){
   try{
	   ...
	   var $showInfoWindow = $("#showInfomation");
	   $showInfoWindow.attr("class","clsShowInfoWindow");
	   $showInfoWindow.css("visibility","visible");
          ...
          $showInfoWindow.css("left",x);
          $showInfoWindow.css("top",y);
          $showInfoWindow.html("");
		  $showInfoWindow.html($(obj).html());
		  $(obj).css("color","red");
...
function hiddenInfoPanel(obj){
      try{
		 ...
		 if($showInfoWindow!=null){
			 $showInfoWindow.html("");
			 $showInfoWindow.css("visibility","hidden");
		 }
